        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 w-full">
          {[
            ...
            <Link href={dept.href} key={dept.name}>
              <div className="bg-black/40 hover:bg-black/60 transition text-white rounded-2xl backdrop-blur-md h-24 w-full shadow-md text-center text-xl font-semibold flex items-center justify-center aspect-square sm:aspect-auto sm:h-18 border-1 border-gray-700">
                {dept.name}
              </div>
            </Link>
          ))}
